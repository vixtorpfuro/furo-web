...
const testimonios = [
  ...
  { quote: '"Trabajar con FURO nos permitio reducir los tiempos de obra significativamente. La precision del sistema es notable"', autor: 'Arturo', rol: 'Cliente', proyecto: 'Casas Lago Bertrand', desc: 'Vivienda / 500 m2' },
