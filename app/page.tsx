...
// Texto que se revela línea por línea
  ...
  return (
    <div ref={ref} style={{ overflow: 'hidden', width: '100%', height: '100%', position: 'absolute', inset: 0 }}>
      <img src={src} alt={alt} style={{
        ...
        transition: `transform 1.2s ${delay}s cubic-bezier(0.16,1,0.3,1)`,
...
function ObraCard({ img, name, tipo }: { img: string, name: string, tipo: string }) {
  ...
  return (
    <div ref={ref} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{ aspectRatio: '3/4', position: 'relative', overflow: 'hidden', cursor: 'pointer', opacity: inView ? 1 : 0, transform: inView ? 'none' : 'translateY(30px)', transition: 'opacity 0.8s cubic-bezier(0.16,1,0.3,1), transform 0.8s cubic-bezier(0.16,1,0.3,1)' }}>
  ...
  return (
    <main style={{ backgroundColor: '#141210', color: '#f5f3ee', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 56px 72px' }}>
          <span className="he d1" style={{ fontSize: 24, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.55)', display: 'block', marginBottom: 0 }}>Build Smarter</span>
          <h1 className="he d2" style={{ fontSize: 'clamp(36px,5vw,68px)', fontWeight: 300, lineHeight: 1.1, color: '#fff', marginBottom: 44 }}>Soluciones constructivas<br />eficientes en madera laminada</h1>
          <div className="he d3" style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '90vh' }}>
        <div style={{ background: '#f5f3ee', padding: '100px 72px 100px 56px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 28 }}>
          ...
          <RevealText delay={0.1} tag="h2" style={{ fontSize: 'clamp(38px,5vw,64px)', fontWeight: 300, lineHeight: 1.05, color: '#141210' }}>Nos involucramos desde el origen de cada proyecto</RevealText>
        ...
        <div style={{ background: '#141210', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        <div style={{ padding: '80px 64px', background: '#e8e5df', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          <span style={{ fontSize: 'clamp(60px,7vw,96px)', fontWeight: 300, lineHeight: 1, color: '#141210', display: 'block', marginBottom: 12 }}>+<CountUp target={80} /></span>
          <span style={{ fontSize: 20, fontWeight: 300, color: '#8a8278' }}>proyectos modelados y solucionados</span>
        </div>
        ...
        <div style={{ padding: '80px 64px', background: '#3a2d5e', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          <span style={{ fontSize: 'clamp(60px,7vw,96px)', fontWeight: 300, lineHeight: 1, color: '#fff', display: 'block', marginBottom: 12 }}>+<CountUp target={2500} suffix=" m2" delay={0.1} /></span>
          <span style={{ fontSize: 20, fontWeight: 300, color: 'rgba(255,255,255,0.55)' }}>planta central</span>
        </div>
        <div style={{ padding: '80px 64px', background: '#c5cdd8', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          <span style={{ fontSize: 'clamp(60px,7vw,96px)', fontWeight: 300, lineHeight: 1, color: '#141210', display: 'block', marginBottom: 12 }}>+<CountUp target={200} delay={0.2} /></span>
          <span style={{ fontSize: 20, fontWeight: 300, color: '#8a8278' }}>soluciones en obras</span>
        </div>
        <div style={{ position: 'relative', minHeight: 360, overflow: 'hidden' }}>
      ...
      {/* BENEFICIOS */}
      <section style={{ padding: '120px 56px', background: '#fff' }} id="beneficios">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'end', paddingBottom: 72, borderBottom: '1px solid rgba(20,18,16,0.08)', marginBottom: 72 }}>
          <div>
            ...
            <RevealText delay={0.1} tag="h2" style={{ fontSize: 'clamp(38px,5vw,64px)', fontWeight: 300, lineHeight: 1.05, color: '#141210' }}>Combinamos los beneficios de la industrializacion y de la madera laminada</RevealText>
          </div>
          <FadeUp delay={0.2}>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        ...
        <div style={{ background: '#f5f3ee', padding: '80px 72px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <FadeUp>
            <blockquote style={{ fontSize: 'clamp(18px,2vw,26px)', fontWeight: 300, lineHeight: 1.55, color: '#141210', marginBottom: 40, minHeight: 160, transition: 'opacity 0.4s' }}>
              {t.quote}
            </blockquote>
      ...
      {/* OBRAS */}
      <section style={{ background: '#141210', padding: '100px 56px' }}>
        <div style={{ borderBottom: '1px solid rgba(255,255,255,0.07)', paddingBottom: 40, marginBottom: 56 }}>
          ...
          <RevealText delay={0.1} tag="h2" style={{ fontSize: 'clamp(12px,5vw,24px)', fontWeight: 300, lineHeight: 1.05, color: '#fff' }}>Seleccion de proyectos</RevealText>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 2, marginBottom: 40 }}>
          ...
          <ObraCard img="/home/autoconstruccion.jpg" name="Construccion de Emergenica" tipo="Vivienda / +5.000 m2" />
        </div>
        <FadeUp>
