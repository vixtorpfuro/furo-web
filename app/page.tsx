...
.home-stats-grid { display: flex; flex-direction: column; }
          .stat-1 { order: 1; }
          .stat-img-1 { order: 2; }
          .stat-2 { order: 3; }
          .stat-img-2 { order: 4; }
...
<section className="home-stats-grid">
        ...
        <div className="stat-2" style={{ background: '#3a2d5e', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          <div className="home-stat-cell" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div className="stat-3" style={{ background: '#c5cdd8', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          <div className="home-stat-cell" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
