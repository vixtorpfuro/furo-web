    ...
    <main style={{ backgroundColor: '#f5f3ee', color: '#141210', fontFamily: 'DM Sans, sans-serif', minHeight: '100vh' }}>
      ...
      <section className="cf-acordeon-grid">
        ...
        <div className="cf-acordeon-right">
          <FadeUp delay={0.1}>
            <p style={{ fontSize: 16, fontWeight: 300, lineHeight: 1.8, color: '#5e5850', marginBottom: 24 }}>Analizamos y modelamos los proyectos de manera precisa, fabricamos y construimos estructuras para desarrollos inmobiliarios, proyectos comerciales, colegios y volumenes que necesitan espacialidad, habitabilidad y eficiencia estructural.</p>
            <p style={{ fontSize: 16, fontWeight: 300, lineHeight: 1.8, color: '#5e5850' }}>En un montaje agil — una construccion tipo lego o mecano — se ensamblan los componentes constituyendo una obra gruesa con menores imprevistos, tiempos de construccion y costos, y una mayor libertad en los espacios.</p>
          </FadeUp>
        </div>
      </section>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', minHeight: '40vh', background: '#141210' }}>
        ...
        <div className="cf-bosque-pad" style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: '40vh' }}>
          <FadeUp>
            <h2 style={{ fontSize: 'clamp(24px,3.5vw,44px)', fontWeight: 300, lineHeight: 1.2, color: '#fff', maxWidth: 480, marginBottom: 32 }}>Nuestra metodologia se adapta a los desafios de cada proyecto</h2>
